...
abstract class $NotificationsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {bool isLoading, String? error, List<NotificationModel> notifications});
}
...
class _$NotificationsStateImpl implements _NotificationsState {
  ...
  @override
  String toString() {
    return 'NotificationsState(isLoading: $isLoading, error: $error, notifications: $notifications)';
  }
...
abstract class _NotificationsState implements NotificationsState {
  const factory _NotificationsState(
      {final bool isLoading,
      final String? error,
      final List<NotificationModel> notifications}) = _$NotificationsStateImpl;
