...
class _$UserRegisterResponseImpl implements _UserRegisterResponse {
  ...
  @override
  String toString() {
    return 'UserRegisterResponse(id: $id, username: $username, email: $email, password: $password, token: $token, referralCode: $referralCode)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, username, email, password, token, referralCode);
