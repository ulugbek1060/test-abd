...
_$BlockDetailResponseImpl _$$BlockDetailResponseImplFromJson(
        Map<String, dynamic> json) =>
    _$BlockDetailResponseImpl(
...
Map<String, dynamic> _$$BlockDetailResponseImplToJson(
        _$BlockDetailResponseImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
      'user': instance.user,
