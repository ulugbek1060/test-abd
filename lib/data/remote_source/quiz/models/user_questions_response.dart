...
part 'user_questions_response.freezed.dart';

part 'user_questions_response.g.dart';

@freezed
class UserQuestionsResponse with _$UserQuestionsResponse {
  const factory UserQuestionsResponse({
    @JsonKey(name: 'count') int? count,
    @JsonKey(name: 'next') String? next,
    @JsonKey(name: 'previous') String? previous,
    @Default([]) @JsonKey(name: 'results') List<Question> results,
  }) = _UserQuestionsResponse;

  factory UserQuestionsResponse.fromJson(Map<String, dynamic> json) =>
      _$UserQuestionsResponseFromJson(json);
}
